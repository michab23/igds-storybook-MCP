...
export function mapCrossReferences(zhData) {
...
function findFuzzyMatch(zhName) {
...
export function getStorybookComponentName(zhName, framework) {
    const mapping = COMPONENT_NAME_MAP[zhName];
    return mapping?.[framework];
}
export function getZeroheightComponentName(storybookName) {
